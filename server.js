...
require('dotenv').config({path: './config/.init'})
...
let dbUrl = process.env.DBSERVER + dbName;
...
app.locals.Conf = require('./config/conf.js');// 
app.locals.Stint = require('./config/stint.js');// 
...
// let whitelist = ['http://localhost:8080', 'http://localhost:8050']
// let corsOptions = {
// 	credentials: true,
